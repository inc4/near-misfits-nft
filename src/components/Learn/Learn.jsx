  ...
  <section id="learn" className="learn">
    <div className="learn__information">
      <h2 className="learn__title">
        <FormattedMessage id="learn.title" defaultMessage="Introducing" />
        <br />
        <FormattedMessage
          id="learn.titleNear"
          defaultMessage=" NEAR Misfits (Gen 0)"
        />
      </h2>
      <p className="learn__text">
        <FormattedMessage
          id="learn.textTop"
          defaultMessage="10,000 brave souls set out into the vast unknown to explore the Metaverse... Only 1,923 survived."
        />
      </p>
      <p className="learn__text">
        <FormattedMessage
          id="learn.textBottom"
          defaultMessage="These Misfits are part of a Decentralised Special Operations crew from all over the world and all walks of life. A group of humans rising to the challenge of their times, coming together to build the Metaverse: challenge the status quo, push the boundaries of what is possible, build and contribute to enabling technology."
        />
      </p>
    </div>
